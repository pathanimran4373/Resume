    ...
    <div>
      <section className="home_page">
        <div className="home_content">
          ...
          <p>	A result oriented professional with 1.6 + years of experience Front End/UI Developer   in “Bit Hub Technology Pvt. ltd.”  from Aug 2021 to Present & extensive experience in all the stages of Designing, Developing, Debugging. <br />My projects are...
          </p>
